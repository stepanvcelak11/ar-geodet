...
def main():
    ...
    r = subprocess.run(['curl', '-s', '-X', 'POST', '-H', 'Authorization: Bearer ' + tok, '-H', 'Content-Type: application/octet-stream', '-H', 'Expect:', '--max-time', '2400', '--speed-time', '90', '--speed-limit', '20000',
