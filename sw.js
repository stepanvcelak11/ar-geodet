...
const SHELL_CACHE = 'argeodet-shell-v316';   // Popisky mapy po ustaleni, AR znacky jen v dosahu, Body po davkach, senzory pod nastroji (data-ag-needs), odpoved na vzkaz
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=316',
    './css/style.css?v=316',
    './css/vylepseni.css?v=316',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
