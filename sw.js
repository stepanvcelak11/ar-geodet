...
const SHELL_CACHE = 'argeodet-shell-v222';   // Jeden stavovy pruh nahore misto dvou (hlaska se kresli v pruhu, ne pod nim)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=222',
    './css/style.css?v=222',
    './css/vylepseni.css?v=222',
    './css/zpravodaj.css',
    './css/predpisy.css',
