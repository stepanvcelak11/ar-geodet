...
const SHELL_CACHE = 'argeodet-shell-v371';   // 18. 9. noc: průchod appkou — odkazy do Nastavení po přestavbě, francouzské vzory, čísla s čárkou
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=371',
    './css/style.css?v=371',
    './css/vylepseni.css?v=371',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
