...
const SHELL_CACHE = 'argeodet-shell-v328';   // mapa: dva body se stejnym id (nivelacni + PPBP na jednom miste) se kresli oba a neprehazuji se
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=328',
    './css/style.css?v=328',
    './css/vylepseni.css?v=328',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
