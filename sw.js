...
const SHELL_CACHE = 'argeodet-shell-v312';   // Kyticka: jedna velikost pisma, sirsi popisky, uzsi listky pri 12 smerech; konzole vlastnika: zalozka Konzole + navrat i s AR
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=312',
    './css/style.css?v=312',
    './css/vylepseni.css?v=312',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
