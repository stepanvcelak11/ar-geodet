...
const SHELL_CACHE = 'argeodet-shell-v234';   // Nastaveni: swipe uklada; opravena smycka hledani; nastroj Kompas; Pocasi bez zdi textu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=234',
    './css/style.css?v=234',
    './css/vylepseni.css?v=234',
    './css/zpravodaj.css',
    './css/predpisy.css',
