...
const SHELL_CACHE = 'argeodet-shell-v320';   // Brana: Dalsi moznosti + Zavrit nepusti dovnitr; protokol bez dlazdic mapy; konzole drzi pohled pri vypadku; kamera z Playe navod; Kdo jsi? srozumitelneji
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=320',
    './css/style.css?v=320',
    './css/vylepseni.css?v=320',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
