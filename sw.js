...
const SHELL_CACHE = 'argeodet-shell-v203';   // otaceni mapy (sever nahore), pracovni karta bodu, sbalitelny nastroj + testy v CI
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=203',
    './css/style.css?v=203',
    './css/vylepseni.css?v=203',
    './css/zpravodaj.css',
    './css/predpisy.css',
