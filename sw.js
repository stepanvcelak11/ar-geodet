...
const SHELL_CACHE = 'argeodet-shell-v313';   // Konzole vlastnika: jedno velke Zpet do konzole v hlavicce (misto malych odkazu v pohledech), vetsi zalozka u cizich oken
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=313',
    './css/style.css?v=313',
    './css/vylepseni.css?v=313',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
