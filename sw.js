...
const SHELL_CACHE = 'argeodet-shell-v337';   // ikony ze sprite misto emoji vsude (Kde co mam, odznaky, PDR, kampan, slunce, radar, zpravodaj...)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=337',
    './css/style.css?v=337',
    './css/vylepseni.css?v=337',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
