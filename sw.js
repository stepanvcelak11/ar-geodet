...
const SHELL_CACHE = 'argeodet-shell-v235';   // Kolecko: plynuly prechod do 2. kruhu, citlivejsi u okraje; Zavady maji plne pozadi
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=235',
    './css/style.css?v=235',
    './css/vylepseni.css?v=235',
    './css/zpravodaj.css',
    './css/predpisy.css',
