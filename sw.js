...
const SHELL_CACHE = 'argeodet-shell-v327';   // modal-close: zaseknute odsunute okno po ztracenem touchend se vrati (konzole 'sprajsle')
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=327',
    './css/style.css?v=327',
    './css/vylepseni.css?v=327',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
