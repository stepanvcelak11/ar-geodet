...
const SHELL_CACHE = 'argeodet-shell-v275';   // vytyceni osy: lomena osa se stanicenim pres lomy, staniceni pocatku, koliky po metrech, lomy i v kamere
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=275',
    './css/style.css?v=275',
    './css/vylepseni.css?v=275',
    './css/gps-warn.css',
