...
const SHELL_CACHE = 'argeodet-shell-v239';   // Kolecko nastroju je KVET: listky, rozvijeni poupete, nazev ve stredovem kvetu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=239',
    './css/style.css?v=239',
    './css/vylepseni.css?v=239',
    './css/zpravodaj.css',
    './css/predpisy.css',
