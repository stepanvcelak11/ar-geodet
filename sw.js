...
const SHELL_CACHE = 'argeodet-shell-v232';   // Vykon a odolnost: min. cteni localStorage, vystuzene Nastaveni a start appky
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=232',
    './css/style.css?v=232',
    './css/vylepseni.css?v=232',
    './css/zpravodaj.css',
    './css/predpisy.css',
