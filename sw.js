...
const SHELL_CACHE = 'argeodet-shell-v398';   // 25. 9.: záloha do účtu (b1) — /account/backup, nabídka obnovy na prázdném telefonu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=398',
    './css/style.css?v=398',
    './css/vylepseni.css?v=398',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
