...
const SHELL_CACHE = 'argeodet-shell-v228';   // Delic ve splitu S1, bila lista hledani, problikavani pilulky, letici hodnoty na uvodu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=228',
    './css/style.css?v=228',
    './css/vylepseni.css?v=228',
    './css/zpravodaj.css',
    './css/predpisy.css',
