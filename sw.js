...
const SHELL_CACHE = 'argeodet-shell-v209';   // opravy po auditu (usla vzdalenost, zamek prihlaseni, tisnove tlacitko) + otaceni mapy, pracovni karta bodu, sbalitelny nastroj, testy v CI
