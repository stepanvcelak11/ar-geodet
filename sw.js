...
const SHELL_CACHE = 'argeodet-shell-v375';   // 19. 9. odp.: Slunce, Mesic a planety za globem (efemeridy), obloha plynule pri pohybu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=375',
    './css/style.css?v=375',
    './css/vylepseni.css?v=375',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
