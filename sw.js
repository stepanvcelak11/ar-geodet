...
const SHELL_CACHE = 'argeodet-shell-v243';   // Seznam souradnic pro kancelar: nastavitelny textovy export (Groma/Kokes/Excel) vc. Windows-1250
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=243',
    './css/style.css?v=243',
    './css/vylepseni.css?v=243',
    './css/zpravodaj.css',
    './css/predpisy.css',
