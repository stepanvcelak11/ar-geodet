...
const SHELL_CACHE = 'argeodet-shell-v309';   // Karta Pro: do konce roku zdarma na zadost, od pristiho roku predplatne (+ preklady)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=309',
    './css/style.css?v=309',
    './css/vylepseni.css?v=309',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
