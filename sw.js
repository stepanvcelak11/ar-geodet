...
const SHELL_CACHE = 'argeodet-shell-v335';   // pruchod appkou: kolize id oken (GNSS predpoved x Geo-fotka), Funguje mi vsechno? Pro, Stopa trasy, Rocenka, svetly motiv zluta
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=335',
    './css/style.css?v=335',
    './css/vylepseni.css?v=335',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
