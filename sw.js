...
const SHELL_CACHE = 'argeodet-shell-v374';   // 19. 9.: souhvezdi za globem (skutecna sfera), kontrola kompasu podle Severky, karticka
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=374',
    './css/style.css?v=374',
    './css/vylepseni.css?v=374',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
