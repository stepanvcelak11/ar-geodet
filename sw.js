...
const SHELL_CACHE = 'argeodet-shell-v175';   // fix scroll-chain (karta bodu vyjizdela pri scrollu v modalech) + doladeni tutorialu; soubezne bezi i prace na uctech (auth-first)
