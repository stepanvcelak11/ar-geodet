...
const SHELL_CACHE = 'argeodet-shell-v354';   // v353 toast+backoff; hodnoceni 18. 9.: trasa bez dialogu, mapa na jednom miste, Nastroje 4→2 vrstvy, zalozka Ovladani, dok na malem displeji, preklady
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=354',
    './css/style.css?v=354',
    './css/vylepseni.css?v=354',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
