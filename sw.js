...
const SHELL_CACHE = 'argeodet-shell-v347';   // nacrt CUZK polozeny na katastr (mapa + AR), vyber N2 ze stranky dohledavani bodu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=347',
    './css/style.css?v=347',
    './css/vylepseni.css?v=347',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
