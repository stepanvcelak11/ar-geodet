...
const SHELL_CACHE = 'argeodet-shell-v240';   // Kolecko nastroju je KVET: listky, rozvijeni poupete, nazev ve stredovem kvetu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=240',
    './css/style.css?v=240',
    './css/vylepseni.css?v=240',
    './css/zpravodaj.css',
    './css/predpisy.css',
