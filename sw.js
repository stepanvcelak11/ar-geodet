...
const SHELL_CACHE = 'argeodet-shell-v311';   // Mrizka Nastroju: nadpis Ucit se (dlazdice studentu padaly do Ostatni, test_v283 v CI)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=311',
    './css/style.css?v=311',
    './css/vylepseni.css?v=311',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
