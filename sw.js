...
const SHELL_CACHE = 'argeodet-shell-v352';   // body GKU SR na Slovensku, Geo karticky, panel Mapa hubenejsi, 3D podle motivu, popisky rovne
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=352',
    './css/style.css?v=352',
    './css/vylepseni.css?v=352',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
