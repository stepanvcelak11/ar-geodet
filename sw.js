...
const SHELL_CACHE = 'argeodet-shell-v276';   // napsat autorovi: trvaly radek v paticce Nastaveni a Nastroju (vidi ho i host), gesto act:napiste, jednotny nazev
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=276',
    './css/style.css?v=276',
    './css/vylepseni.css?v=276',
    './css/gps-warn.css',
