...
const SHELL_CACHE = 'argeodet-shell-v192';   // fix kompas requestPermission bez gesta + krizek na stavovem pruhu GPS/offline
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=192',
    './css/style.css?v=192',
    './css/vylepseni.css?v=192',
    './css/zpravodaj.css',
    './css/predpisy.css',
