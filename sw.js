...
const SHELL_CACHE = 'argeodet-shell-v399';   // 25. 9.: překlady PDOP a kontrastu; záloha do účtu v testech vypnutá (falešný token)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=399',
    './css/style.css?v=399',
    './css/vylepseni.css?v=399',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
