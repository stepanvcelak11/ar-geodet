...
const SHELL_CACHE = 'argeodet-shell-v186';   // zavady/hlaseni poruch + usadit-ar pruvodce + stavovy pruh + tokens-outdoor (nad integraci 8)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=186',
    './css/style.css?v=186',
    './css/vylepseni.css?v=186',
    './css/zpravodaj.css',
    './css/predpisy.css',
