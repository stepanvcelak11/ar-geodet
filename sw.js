...
const SHELL_CACHE = 'argeodet-shell-v233';   // Nastroje v liste o slot niz, zesileni kolecka u okraje, svetelna hrana delice
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=233',
    './css/style.css?v=233',
    './css/vylepseni.css?v=233',
    './css/zpravodaj.css',
    './css/predpisy.css',
