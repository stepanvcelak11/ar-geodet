...
const SHELL_CACHE = 'argeodet-shell-v272';   // kos pobere i hromadne mazani, hledani neodkryje zakazane nastroje, nastroj se najde pod svym jmenem, zablokovany ucet se sam odhlasi
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=272',
    './css/style.css?v=272',
    './css/vylepseni.css?v=272',
    './css/zpravodaj.css',
    './css/predpisy.css',
