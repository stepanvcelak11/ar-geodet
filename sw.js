...
const SHELL_CACHE = 'argeodet-shell-v372';   // 18. 9. večer: 3. kolo T1–T6 (start bez signálu bez toastu, rozcestníky, CI, vizuál, stav spojení, EN Nový bod)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=372',
    './css/style.css?v=372',
    './css/vylepseni.css?v=372',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
