...
const SHELL_CACHE = 'argeodet-shell-v315';   // Dosah bodu 300/100 m, rezim Slabsi telefon, Sdilet aplikaci jen vlastnik
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=315',
    './css/style.css?v=315',
    './css/vylepseni.css?v=315',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
