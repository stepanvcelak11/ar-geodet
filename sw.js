...
const SHELL_CACHE = 'argeodet-shell-v373';   // 19. 9.: vesmír za glóbem ve 3D pohledu (hvězdy, Mléčná dráha, Měsíc ve skutečné fázi, atmosféra)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=373',
    './css/style.css?v=373',
    './css/vylepseni.css?v=373',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
