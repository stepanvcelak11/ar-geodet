...
const SHELL_CACHE = 'argeodet-shell-v401';   // 25. 9.: přístupnost (c1) — popisky, oblasti, kontrast, písmo do 200 %; ikony cesty učení bez emoji
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=401',
    './css/style.css?v=401',
    './css/vylepseni.css?v=401',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
    ...
    './js/pohled-3d.js',
    './css/pohled-3d.css',
    './js/mistopisny-nacrt.js',
    './css/mistopisny-nacrt.css',
    './js/scroll-uceni.js',
    './css/scroll-uceni.css',
    './js/vrstvy.js',
    './js/denik-dne.js',
    './js/kniha-jizd.js',
    './js/postupy.js',
