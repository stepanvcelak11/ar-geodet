...
const SHELL_CACHE = 'argeodet-shell-v215';   // Slouceno 5 vetvi (4 session): dialogy, pisma z repa, vykon seznamu a mapy, indikator schovanych bodu
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=215',
    './css/style.css?v=215',
    './css/vylepseni.css?v=215',
    './css/zpravodaj.css',
    './css/predpisy.css',
