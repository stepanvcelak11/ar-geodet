...
const SHELL_CACHE = 'argeodet-shell-v280';   // Zaklad vs Pro: delici cara v registru, licencni klic, zamky placenych nastroju
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=280',
    './css/style.css?v=280',
    './css/vylepseni.css?v=280',
    './css/gps-warn.css',
