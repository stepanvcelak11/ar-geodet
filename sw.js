...
const SHELL_CACHE = 'argeodet-shell-v350';   // panel Mapa ve trech patrech, trasa i bez vektorove mapy na obrazovce, prekazka na platne
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=350',
    './css/style.css?v=350',
    './css/vylepseni.css?v=350',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
