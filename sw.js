...
const SHELL_CACHE = 'argeodet-shell-v367';   // 18. 9. vecer: kontrola mesice — bez toastu bez signalu, prazdny rozcestnik, slovnik +70, textarea placeholder
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=367',
    './css/style.css?v=367',
    './css/vylepseni.css?v=367',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
