...
const SHELL_CACHE = 'argeodet-shell-v244';   // Sjednocene dvojice nastroju + AR primka, kvet ke krajum, libela v metru, swipe u nastroju
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=244',
    './css/style.css?v=244',
    './css/vylepseni.css?v=244',
    './css/zpravodaj.css',
    './css/predpisy.css',
