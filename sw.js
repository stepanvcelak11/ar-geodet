...
const SHELL_CACHE = 'argeodet-shell-v346';   // oprava GPS z mapy za chuze (zivy posun), web novy vzhled, hlaska po stazeni verze
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=346',
    './css/style.css?v=346',
    './css/vylepseni.css?v=346',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
