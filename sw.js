...
const SHELL_CACHE = 'argeodet-shell-v299';   // Hledani v Nastaveni: prvni tik po otevreni uz nemaze rozepsany text (zavod casovace s psanim)
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=299',
    './css/style.css?v=299',
    './css/vylepseni.css?v=299',
    './css/gps-warn.css',
