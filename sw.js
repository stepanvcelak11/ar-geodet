...
const SHELL_CACHE = 'argeodet-shell-v330';   // sekce Presne mereni: pruvodce, uzavreny tvar + kalibrace pred a po, kam s telefonem, docasna zakladna DGPS
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=330',
    './css/style.css?v=330',
    './css/vylepseni.css?v=330',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
