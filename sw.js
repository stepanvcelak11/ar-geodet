...
const SHELL_CACHE = 'argeodet-shell-v289';   // Vlastnik: konzole viditelne v Nastaveni/Nastrojich/Vice, stazeni dat firmy do vlastni appky
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=289',
    './css/style.css?v=289',
    './css/vylepseni.css?v=289',
    './css/gps-warn.css',
