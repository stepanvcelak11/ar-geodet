...
const SHELL_CACHE = 'argeodet-shell-v370';   // 18. 9. noc: karta „Měříš v zemi“ hned po startu v cizině + Nastavení „Co tu appka umí“
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=370',
    './css/style.css?v=370',
    './css/vylepseni.css?v=370',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
