...
const SHELL_CACHE = 'argeodet-shell-v300';   // Prohlidka 13. 9.: tykani vsude + slovnik, verze v O aplikaci, historie v286-v299, DMT hlavicka, pilulka, brana
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=300',
    './css/style.css?v=300',
    './css/vylepseni.css?v=300',
    './css/gps-warn.css',
