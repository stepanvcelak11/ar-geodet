...
const SHELL_CACHE = 'argeodet-shell-v223';   // Nastaveni: srovnane posuvniky a zalozky; pruvodce vlastnim profilem; NUL bajty ze zdroju
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=223',
    './css/style.css?v=223',
    './css/vylepseni.css?v=223',
    './css/zpravodaj.css',
    './css/predpisy.css',
