...
const SHELL_CACHE = 'argeodet-shell-v324';   // modal-close: zaseknute odsunute okno po ztracenem touchend se vrati (konzole 'sprajsle')
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=324',
    './css/style.css?v=324',
    './css/vylepseni.css?v=324',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
