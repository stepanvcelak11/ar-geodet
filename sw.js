...
const SHELL_CACHE = 'argeodet-shell-v281';   // Zaklad vs Pro: delici cara v registru, licencni klic, zamky placenych nastroju
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=281',
    './css/style.css?v=281',
    './css/vylepseni.css?v=281',
    './css/gps-warn.css',
