...
const SHELL_CACHE = 'argeodet-shell-v271';   // cesta zpet z omezeneho rezimu, prepinani firem pro kazdeho, slouceni nastroju, prohlidka pres celou obrazovku, okno neproblikne
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=271',
    './css/style.css?v=271',
    './css/vylepseni.css?v=271',
    './css/zpravodaj.css',
    './css/predpisy.css',
