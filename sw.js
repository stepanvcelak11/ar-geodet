...
const SHELL_CACHE = 'argeodet-shell-v323';   // modal-close: zaseknute odsunute okno po ztracenem touchend se vrati (konzole 'sprajsle')
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=323',
    './css/style.css?v=323',
    './css/vylepseni.css?v=323',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
