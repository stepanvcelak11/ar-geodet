...
const SHELL_CACHE = 'argeodet-shell-v393';   // 24. 9.: čtení fotek offline, test letadlového režimu, zbytky češtiny, poctivá rada k ikoně
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=393',
    './css/style.css?v=393',
    './css/vylepseni.css?v=393',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
