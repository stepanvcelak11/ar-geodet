...
const SHELL_CACHE = 'argeodet-shell-v406';   // 25. 9.: oprava nasazení workeru v31 (passkey) + Moje přesnost ve Zjistit podmínky
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=406',
    './css/style.css?v=406',
    './css/vylepseni.css?v=406',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
