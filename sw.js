...
const SHELL_CACHE = 'argeodet-shell-v322';   // modal-close: zaseknute odsunute okno po ztracenem touchend se vrati (konzole 'sprajsle')
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=322',
    './css/style.css?v=322',
    './css/vylepseni.css?v=322',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
