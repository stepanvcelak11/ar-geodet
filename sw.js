...
const SHELL_CACHE = 'argeodet-shell-v355';   // pruchod 18. 9.: IndexedDB (prehled mista nezaklada cizi DB + samolecba), nacrt ikona Posun, karta S-JTSK z polohy, kolecko Sbalit
...
const ASSETS_TO_CACHE = [
    ...
    './css/tokens.css?v=355',
    './css/style.css?v=355',
    './css/vylepseni.css?v=355',
    './css/pro-vzhled.css',
    './css/gps-warn.css',
