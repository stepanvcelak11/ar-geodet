...
(function () {
    ...
    function injectStyles() {
        ...
        st.textContent = [
            ...
            '#' + BAR_ID + ' .agm-t{flex:0 0 auto;font-size:10.5px;letter-spacing:.04em;text-transform:uppercase;color:var(--accent,#2f9e74);}',
            ...
            'body.ag-glove #' + BAR_ID + '{font-size:13px;padding:9px 10px 9px 15px;}',
