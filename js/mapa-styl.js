...
// restaurace, zastávky, reklamy. Jedna funkce, čtyři varianty z jedněch dat:
//   den · noc (opravdu tmavá, ne invertovaný obrázek) · modrotisk · tisk (černobílá do PDF)
//
...
(function () {
    ...
    var PALETY = {
        den: { zem: '#f1f2ee', voda: '#a8c8dc', vodaCara: '#7fb0cc', les: '#c6d9b3', pole: '#efeedb', trava: '#d9e6c4', zastavba: '#e9e8e2', prumysl: '#e2e0e0', kolej: '#8a8a8a',
            budova: '#d8d3c6', budovaHrana: '#a89f8c', silnice: '#ffffff', silniceHrana: '#b9b4a8', dalnice: '#f6d58a', cesta: '#c9b99a', hranice: '#9a7ab8', text: '#2f3530', textHalo: '#f1f2ee', cislo: '#5b4e3a', leteckaPruhled: 1 },
        noc: { zem: '#151a19', voda: '#173040', vodaCara: '#2a5570', les: '#1a2820', pole: '#1b1f1a', trava: '#1c2a1e', zastavba: '#1c2120', prumysl: '#212524', kolej: '#6a6f6d',
            budova: '#2a312f', budovaHrana: '#4c5754', silnice: '#39423f', silniceHrana: '#1a1f1e', dalnice: '#6b5a2a', cesta: '#4a4335', hranice: '#6f5a8a', text: '#d5ddd8', textHalo: '#151a19', cislo: '#c9b98f', leteckaPruhled: 1 },
        modrotisk: { zem: '#0b2a5a', voda: '#12386e', vodaCara: '#6fa8ff', les: '#0e3062', pole: '#0b2a5a', trava: '#0d2d5e', zastavba: '#0d2e60', prumysl: '#0d2e60', kolej: '#9cc4ff',
            budova: 'rgba(0,0,0,0)', budovaHrana: '#9cc4ff', silnice: '#0b2a5a', silniceHrana: '#9cc4ff', dalnice: '#123a78', cesta: '#5f8fd6', hranice: '#c9dcff', text: '#dbe8ff', textHalo: '#0b2a5a', cislo: '#dbe8ff', leteckaPruhled: 1 },
        tisk: { zem: '#ffffff', voda: '#e6e6e6', vodaCara: '#8c8c8c', les: '#eeeeee', pole: '#ffffff', trava: '#f4f4f4', zastavba: '#fafafa', prumysl: '#f2f2f2', kolej: '#333333',
            budova: '#dddddd', budovaHrana: '#555555', silnice: '#ffffff', silniceHrana: '#444444', dalnice: '#cccccc', cesta: '#777777', hranice: '#222222', text: '#000000', textHalo: '#ffffff', cislo: '#000000', leteckaPruhled: 1 }
    };
    ...
    function vytvor(varianta, zdrojUrl) {
        ...
        var vrstvy = [
            ...
            { id: 'cesty', type: 'line', source: 'pm', 'source-layer': 'roads', filter: ['==', ['get', 'kind'], 'path'], minzoom: 13,
            ...
            // budovy: výplň + hrana; v modrotisku jen hrana
            { id: 'budovy', type: 'fill', source: 'pm', 'source-layer': 'buildings', minzoom: 13, paint: { 'fill-color': P.budova, 'fill-opacity': modro ? 0 : ['interpolate', ['linear'], ['zoom'], 13, 0.55, 16, 0.95] } },
    ...
    window.AGMapaStyl = { vytvor: vytvor, PALETY: PALETY, VARIANTY: ['den', 'noc', 'modrotisk', 'tisk'] };
})();
