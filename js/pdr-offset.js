...
(function () {
    ...
    function renderModal() {
        ...
        body.innerHTML =
            ...
            + '<input id="ag-pdr-len" class="bgps-name" type="text" inputmode="decimal" step="0.01" min="0.4" max="1.2" value="' + stepLen().toFixed(2) + '" style="width:100%; margin:4px 0 10px;">'
        ...
        if (go) go.addEventListener('click', function () {
            var v = agNum(document.getElementById('ag-pdr-len').value);
