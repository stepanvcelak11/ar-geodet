...
(function () {
    ...
    function injectStyle() {
        ...
        st.textContent =
            ...
            + '.agc2-sel label{display:block;font-size:11px;opacity:0.65;margin:0 0 3px 2px}'
            + '.agc2-sel select{width:100%;box-sizing:border-box;padding:10px;border-radius:10px;background:#1c212b;color:#fff;border:1px solid rgba(255,255,255,0.15);font-size:14px}'
            ...
            + '#agc2-aim .agc2-top{background:rgba(10,12,16,0.82);border:1px solid rgba(255,255,255,0.14);border-radius:12px;padding:11px 13px;text-align:center;font-size:14px}'
            ...
            + '#agc2-fov .agc2-top{background:rgba(10,12,16,0.82);border:1px solid rgba(255,255,255,0.14);border-radius:12px;padding:10px 13px;text-align:center;font-size:13.5px}'
            + '.agc2-fbar{background:rgba(10,12,16,0.9);border:1px solid rgba(255,255,255,0.14);border-radius:14px;padding:12px 14px}'
            + '.agc2-fbar .agc2-fval{text-align:center;font-size:15px;font-weight:700;margin-bottom:8px}'
            + '.agc2-fbar .agc2-fctl{display:flex;align-items:center;gap:10px}'
            + '.agc2-fbar input[type=range]{flex:1;min-width:0}'
            + '.agc2-fbar .agc2-step{flex:0 0 auto;width:44px;height:44px;border-radius:11px;border:1px solid rgba(255,255,255,0.2);background:#1c212b;color:#fff;font-size:22px;line-height:1;cursor:pointer}'
