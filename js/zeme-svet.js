...
(function () {
    ...
    function ui() {
        ...
        if (kotva) { tab.insertBefore(h, kotva); tab.insertBefore(row, kotva); tab.insertBefore(pozn, kotva); }
        else { tab.appendChild(h); tab.appendChild(row); tab.appendChild(pozn); }
        obnov();
    }
