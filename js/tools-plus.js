...
(function () {
    ...
    var TOOL_HELP = {
        ...
        'hlasovky': { t: 'Hlasové poznámky', h: '<p>Poznámky namluvené místo psaní — v rukavicích a blátě se nepíše. Každá hlasovka dostane <b>georazítko</b>: čas, polohu (S-JTSK), přesnost GPS a nejbližší vlastní bod do 25 m („u bodu 105, 3 m").</p><ol><li>Klepni <b>Nahrát poznámku</b>, řekni co vidíš, klepnutím zastavíš (strop 5 minut).</li><li>V seznamu poznámku přehraješ, dopíšeš k ní text, sdílíš jako soubor nebo smažeš (dvojím ťuknutím).</li><li>Večer je posbírá <b>Deník dne</b> — v souhrnu vidíš čas, délku a u jakého bodu vznikly.</li></ol><p>Funguje offline, ukládá se jen do telefonu (poznámky se necloudují a nepřenášejí se s exportem zakázky). Na iOS může start mikrofonu na okamžik škubnout obrazem kamery.</p>' }
