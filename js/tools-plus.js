...
(function () {
    ...
    var TOOL_HELP = {
        ...
        'photo-shot': { t: 'Zaměřit bod kamerou', h: '<p>„Foto-totálka": bod zaměříš namířením kříže kamery — poloha se dopočítá z tvé pozice, azimutu a svislého úhlu k zemi (výška očí).</p><ol><li>Zkontroluj srovnaný sever (kalibrace) a nastav výšku očí.</li><li>Zamiř kříž na patu cíle na zemi a spusť zaměření.</li><li>Výsledek ulož jako bod; přesnost odpovídá kompasu a GPS — na orientační body, ne na katastr.</li></ol>' },
        ...
        'pocasi': { t: 'Počasí', h: '<p>Předpověď pro místo měření složená z <b>deseti předpovědních modelů</b> národních meteorologických služeb (ECMWF, DWD ICON-D2/EU, KNMI a DMI HARMONIE, Météo-France, UK Met Office, NOAA, CMC) a MET Norway. Hodnoty se váženě průměrují — dlaždice <b>Shoda zdrojů</b> ukazuje, jak moc se modely rozcházejí; velký rozptyl = nejistá předpověď.</p><ol><li>Bez zadání ukazuje počasí ve tvé poloze.</li><li>Ikonou <b>špendlíku</b> vybereš místo klepnutím do mapy — třeba zakázku, kam teprve pojedeš.</li><li>Do pole nahoře můžeš místo taky vyhledat podle názvu.</li></ol><p>Upozornění hlídají, co vadí v terénu: bouřka a déšť do 3 h, vítr nad 8 m/s (stativ, výtyčka), mráz a vedro. Poslední stažená předpověď se pamatuje i offline.</p>' },
        ...
        'dochazka': { t: 'Docházka', h: '<p>Příchod a odchod na zakázce s razítkem času a GPS polohy — podklad pro výkaz odpracovaných hodin.</p><ol><li>Na místě klepni <b>Příchod</b>, na konci <b>Odchod</b>.</li><li>Když odchod zapomeneš, doplníš ho při dalším startu (nebo ho opraví admin).</li><li>Administrace firmy páruje směny a počítá hodiny, výkaz jde vyexportovat do CSV nebo vytisknout.</li></ol><p>Funguje i offline — záznamy se odešlou, až bude signál.</p>' },
