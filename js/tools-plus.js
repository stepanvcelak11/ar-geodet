...
(function () {
    ...
    var TOOL_HELP = {
        ...
        'sklonomer': { t: 'Sklonoměr (%)', h: '<p>Příčný sklon vrstvy z akcelerometru telefonu: polož telefon (ideálně na 2m lati) podélnou osou po spádu a čti sklon v %.</p><ol><li>Zadej cílový sklon (např. 2,5 %) a toleranci — hodnota svítí zeleně/červeně.</li><li><b>HOLD</b> zmrazí čtení pro opsání.</li><li><b>Kalibrace otočením</b> o 180° vyruší křivost telefonu/obalu — udělej ji před měřením.</li></ol>' }
    };
