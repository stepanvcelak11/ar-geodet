...
(function () {
    ...
    var TOOL_HELP = {
        ...
        'bezpecnost': { t: 'Bezpečnost', h: '<p>Rizika dneška venku na jedné kartě: bouřka, vedro a pitný režim, mráz a náledí, silný vítr, blížící se tma. Plus poslání vlastní polohy, když je potřeba někoho k sobě navést.</p><ol><li>Karta se plní z posledního staženého <b>počasí</b> a z časů soumraku (počítá modul Slunce).</li><li>Přepínačem zapneš <b>tiché připomínky</b> (pití ve vedru, bouřka, 30 min před tmou) — jen nenápadný toast, žádný zvuk; <b>Ztišit na dnes</b> je jeden tap.</li><li><b>Poslat mou polohu</b> otevře systémové sdílení s polohou ve WGS84 i S-JTSK a odkazem do mapy.</li></ol><p>Appka sama nikam nic neposílá a nikoho nevolá — tíseň volej 112. Uvedené hodnoty jsou orientační doporučení, ne citace předpisů: povinnosti zaměstnavatele (ochranné nápoje, bezpečnostní přestávky) řeší NV 361/2007 Sb. podle třídy práce a naměřených podmínek. Připomínky běží jen když je appka otevřená.</p>' }
    };
