...
(function () {
    ...
    function injectStyles() {
        ...
        st.textContent = [
            ...
            '  color:var(--text-color,#e6eaf0);font:600 13px/1.15 var(--font-ui,system-ui),sans-serif;padding:5px 4px;}',
            ...
            '  border:1px solid var(--glass-border,rgba(255,255,255,0.14));background:var(--surface-2,rgba(255,255,255,0.06));',
            '  color:var(--text-color,#e6eaf0);font:600 14px/1 var(--font-mono,monospace);}',
