...
(function () {
    ...
    function injectStyles() {
        ...
        st.textContent = [
            ...
            '.ag-ob-note.warn{border-color:rgba(251,191,36,0.42);background:rgba(251,191,36,0.09);color:var(--warning,#fbbf24);}',
    ...
    function open() {
        ...
        if (!m) {
            ...
            m.id = 'ag-ob-modal'; m.setAttribute('data-ag-needs', 'gps'); /* js/power-save.js: senzory neuspávat, dokud je okno vidět */
            m.innerHTML =
