...
(function () {
    ...
    function injectStyles() {
        ...
        st.textContent = [
            ...
            '#' + MODAL_ID + ' .ag-ep-item-name{font:700 14px/1.2 var(--font,system-ui),sans-serif;margin-right:6px;}',
            '#' + MODAL_ID + ' .ag-ep-item-sub{display:block;font-size:11.5px;opacity:.75;margin-top:3px;line-height:1.4;}',
            '#' + MODAL_ID + ' .ag-ep-badge{font:700 10px/1 var(--font,system-ui),sans-serif;padding:3px 7px;border-radius:8px;vertical-align:middle;}',
            '#' + MODAL_ID + ' .ag-ep-ok{background:rgba(52,211,153,0.18);color:#34d399;}',
