...
(function () {
    ...
    function injectStyles() {
        ...
        st.textContent = [
            ...
            '#agvo-step{font:700 11px/1 var(--font,system-ui),sans-serif;color:#94a3b8;letter-spacing:0.08em;margin-bottom:5px;}',
            '#agvo-v{font:800 32px/1 var(--font-mono,monospace);color:#4da3ff;}',
            '#agvo-sub{margin-top:4px;font:600 12px/1.4 var(--font,system-ui),sans-serif;color:#cbd5e1;}',
