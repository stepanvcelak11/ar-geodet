...
// PWA: nova verze ceka -> nabidnout obnovu (resi matouci starou cache)
        ...
        function applyVisualSettings() {
            ...
            document.documentElement.style.setProperty('--dock-lift', (visSettings.dockOffset || 0) + 'px');
            document.documentElement.style.setProperty('--dock-arc', (visSettings.dockArc || 0) + 'px');
        ...
        function saveSettings() { 
            ...
            { var _dl = document.getElementById('v-dock-lift'); if (_dl) visSettings.dockOffset = parseInt(_dl.value); }
