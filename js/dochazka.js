...
(function () {
    ...
    function injectStyles() {
        ...
        st.textContent = [
            ...
            '#agdo-modal .agdo-status b{font:700 15px/1.3 var(--font-ui,system-ui);color:var(--text-color,#e6e8eb);display:block;}',
            ...
            '#agdo-modal .agdo-card b{display:block;font:800 20px/1.2 var(--font-display,system-ui);color:var(--text-color,#e6e8eb);}',
            '#agdo-modal .agdo-card span{font:600 10.5px/1.3 var(--font-ui,system-ui);color:var(--text-muted,#9aa1ac);}',
            '#agdo-modal .agdo-day{font:700 12px/1 var(--font-ui,system-ui);color:var(--text-color,#e6e8eb);margin:13px 0 3px;}',
            ...
            '  font:500 12.5px/1.3 var(--font-ui,system-ui);color:var(--text-color,#e6e8eb);}',
            ...
            '  border:1px solid var(--glass-border,rgba(255,255,255,0.16));border-radius:11px;color:var(--text-color,#e6e8eb);padding:11px 12px;',
