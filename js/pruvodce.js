    ...
    function stepCollectConfig() {
        ...
        render({
            ...
            body: '<p style="font-size:calc(13px * var(--ag-font-scale, 1)); opacity:0.8; margin-top:0;">Nastav si, jak se mají body číslovat a jakou přesnost chceš. Vše můžeš změnit.</p>'
                ...
                + '<label>Práh přesnosti (m, volitelné — varuje při horší):</label><input type="text" inputmode="decimal" autocomplete="off" id="pruv-c-thr" value="' + (c.threshold != null ? c.threshold : '') + '" step="0.01" placeholder="např. 0.30">'
            ...
            footer: [
                ...
                { label: 'Spustit sběr', cls: 'btn-primary', icon: 'locate', act: function () {
                    ...
                    var thr = (typeof window.agNum === 'function') ? window.agNum('pruv-c-thr') : parseFloat(String((document.getElementById('pruv-c-thr') || {}).value).replace(',', '.')); c.threshold = isNaN(thr) ? null : thr;
