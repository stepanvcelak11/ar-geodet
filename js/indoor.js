...
(function () {
    ...
    function toSJTSK(lat, lng) {
        try { if (window.GeoCore && GeoCore.toMistni) return GeoCore.toMistni(lat, lng); } catch (e) { window.AG && AG.swallow && AG.swallow(e, 'indoor:toSJTSK'); }
    ...
    function refresh() {
        ...
        if (pos) {
            ...
            pos.innerHTML = sj
                ...
                : 'Odhad polohy se nedá převést do ' + agSys() + '.';
        }
