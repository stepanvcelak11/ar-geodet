...
//   • data/jazyky-en|de|pl|es|it|fr|nl|pt.json — ROZŠÍŘENÍ (~6 700 klíčů, ~480 kB na jazyk).
...
(function () {
    ...
    var LANGS = [CS, { c: 'en', n: 'English' }, { c: 'de', n: 'Deutsch' }, { c: 'pl', n: 'Polski' },
        { c: 'es', n: 'Español' }, { c: 'it', n: 'Italiano' }, { c: 'fr', n: 'Français' }, { c: 'nl', n: 'Nederlands' }, { c: 'pt', n: 'Português' }];
    ...
    function detect() {
        ...
        for (var i = 0; i < l.length; i++) {
            ...
            if (c === 'en' || c === 'de' || c === 'pl' || c === 'es' || c === 'it' || c === 'fr' || c === 'nl' || c === 'pt') return c;
        }
    ...
    window.AGJazyk = {
        ...
        locale: function () { return { cs: 'cs-CZ', en: 'en-GB', de: 'de-DE', pl: 'pl-PL', es: 'es-ES', it: 'it-IT', fr: 'fr-FR', nl: 'nl-NL', pt: 'pt-PT' }[_lang] || 'cs-CZ'; },
        set: set,
