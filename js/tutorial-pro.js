...
(function () {
    ...
    var BASIC = [
        ...
        { title: 'Nástroje', target: '#dock button[onclick*="tools-modal"]', body: 'Měření vzdálenosti a plochy, kalkulačka, GNSS satelity, vytyčovací checklist, náčrt — a pokročilé geodetické nástroje. Nástroje jsou seřazené podle <b>sloves</b> (Změřit, Nový bod, Vytyčit…) — listuješ tahem nebo klepnutím na sloveso; co používáš pořád, připni <b>hvězdičkou</b>. Schované nástroje najde vyhledávání vždy.' },
        { title: 'Vrstvy', target: '#dock-vice-btn', body: 'Podkladová mapa, katastr a další vrstvy. Návod, sdílení a „o aplikaci" najdeš v <b>Nastavení → Účet a aplikace</b>.' },
        { title: 'Nastavení', target: '#dock button[onclick*="openSettings"]', body: 'Nahoře karta <b>Časté</b> — dosah bodů v kameře i v mapě, strop bodů, světlý/tmavý, venkovní režim a druhy úředních bodů. Pod ní kategorie jako řádky: <b>AR kamera</b>, <b>Mapa a body</b>, Vzhled, Ovládání, Výkon a baterie, Zakázka a data; záloha a účet jsou dole v „Méně často".' },
    ...
    var ADV = [
        ...
        },
        {
            ...
            body: 'Nevíš, čím začít? <b>Průvodce úkolem</b> (dole v <b>Nástrojích</b>: „Poradit, co použít") ti podle činnosti — vytyčování, sběr bodů, úřední body, měření — sám nachystá zakázku a správné nástroje.',
            before: function () {
