...
(function () {
    ...
    function ensureModal() {
        ...
        el.innerHTML =
            ...
            + '<h3 style="color:var(--accent);margin-top:0;">' + ICON + ' Vizuální stabilizace AR <span style="font-size:calc(12px * var(--ag-font-scale, 1));opacity:.6;">(beta)</span></h3>'
            + '<p style="font-size:calc(12.5px * var(--ag-font-scale, 1));opacity:.82;margin:2px 0 10px;line-height:1.45;">Mezi pomalými GPS/kompas fixy sleduje appka <b>pohyb obrazu z kamery</b> a drží AR značky stabilní. '
