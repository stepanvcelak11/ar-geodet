...
(function () {
    ...
    function ensureModal() {
        ...
        el.className = 'modal-overlay'; el.id = 'agor-modal'; el.setAttribute('data-ag-needs', 'gps kompas'); /* js/power-save.js: senzory neuspávat, dokud je okno vidět */ el.style.zIndex = '100001';
        el.innerHTML =
