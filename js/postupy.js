...
(function () {
    ...
    function injectStyles() {
        ...
        st.textContent = [
            ...
            '#ag-pm-head h2{margin:0;font-size:17px;flex:1;color:var(--accent,#34d399);}',
            ...
            '.ag-pm-item b{display:block;font-size:15px;color:var(--accent,#34d399);margin-bottom:4px;}',
            ...
            '.ag-pm-step input{margin-top:2px;flex:0 0 auto;width:18px;height:18px;accent-color:var(--accent,#34d399);}',
            ...
            '.ag-pm-note{padding:10px 12px;border-left:3px solid var(--accent,#34d399);border-radius:8px;background:var(--accent-soft,rgba(52,211,153,0.08));font-size:13px;line-height:1.5;}',
