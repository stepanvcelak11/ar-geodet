...
(function () {
    ...
    function build() {
        ...
        m.innerHTML = '<div class="modal-content">'
            ...
            + '<div class="ss-grid">'
            + '<button type="button" class="ss-b" data-v="student"><span class="ic">S</span><span><h4>' + t('Student') + '</h4><p>' + t('Učím se geodézii. Nahoře chci Trenažér, cvičné úlohy, vzorce a poznávačku; spolužáci a učitel jsou „parta", ne firma.') + '</p></span></button>'
            + '<button type="button" class="ss-b" data-v="geodet"><span class="ic">G</span><span><h4>' + t('Geodet') + '</h4><p>' + t('Měřím a vytyčuju. Nástroje podle toho, co dnes dělám; učení až na konci seznamu.') + '</p></span></button>'
            + '<button type="button" class="ss-b" data-v="firma"><span class="ic">F</span><span><h4>' + t('Firma') + '</h4><p>' + t('Víc lidí na zakázkách: účty, role, sdílení bodů. Rovnou otevřu založení firmy, když ještě žádná není.') + '</p></span></button>'
            + '</div>'
            + '<p class="ss-pozn">' + t('Nic z toho nezamyká žádný nástroj — jen pořadí a slova.') + '</p>'
